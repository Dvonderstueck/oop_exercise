...
new_student1.add_grade(math_discipline.name, total_points_exam1)
...
new_student1.add_grade(math_discipline.name, total_points_exam2)
...
print(f"Total points earned in exam1: {total_points_exam1}")
new_student1.add_grade(english_discipline.name, total_points_exam1)
...
print(f"Total points earned in exam2: {total_points_exam2}")
new_student1.add_grade(english_discipline.name, total_points_exam2)
...
print(f"Total points earned in exam1: {total_points_exam1}")
new_student1.add_grade(physics_discipline.name, total_points_exam1)
...
print(f"Total points earned in exam2: {total_points_exam2}")
new_student1.add_grade(physics_discipline.name, total_points_exam2)
