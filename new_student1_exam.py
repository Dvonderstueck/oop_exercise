...
user_inputs_exam1 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam1_math))
...
new_student1.add_grade(math_discipline.name, total_points_exam1_math)
new_student1.save_points_to_file(math_discipline.name, "exam1")

 #Math exam 2
teacher_questions_exam2_math = exam2_math.exam_questions
user_inputs_exam2 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam2_math))
...
new_student1.add_grade(math_discipline.name, total_points_exam2_math)
new_student1.save_points_to_file(math_discipline.name, "exam2")

#Math exam3
teacher_questions_exam3_math = exam3_math.exam_questions
user_inputs_exam3 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam3_math))
...
new_student1.add_grade(math_discipline.name, total_points_exam3_math)
...
user_inputs_exam1 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam1_english))
...
new_student1.add_grade(english_discipline.name, total_points_exam1_english)
new_student1.save_points_to_file(english_discipline.name, "exam1")


#English exam 2
teacher_questions_exam2_english = exam2_english.exam_questions
user_inputs_exam2 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam2_english))
...
new_student1.add_grade(english_discipline.name, total_points_exam2_english)
new_student1.save_points_to_file(english_discipline.name, "exam2")


#physics exam 1
teacher_questions_exam1_physics = exam1_physics.exam_questions
user_inputs_exam1 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam1_physics))
...
new_student1.add_grade(physics_discipline.name, total_points_exam1_physics)
new_student1.save_points_to_file(physics_discipline.name, "exam1")


#physics exam 2
teacher_questions_exam2_physics = exam2_physics.exam_questions
user_inputs_exam2 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam2_physics))
...
new_student1.add_grade(physics_discipline.name, total_points_exam2_physics)
new_student1.save_points_to_file(physics_discipline.name, "exam2")


#physics exam 3
teacher_questions_exam3_physics = exam3_physics.exam_questions
user_inputs_exam3 = list(map(lambda q: (q[0], q[1], new_student1.get_input(f"{q[0]} - {q[1]}: ")), teacher_questions_exam3_physics))
...
new_student1.add_grade(physics_discipline.name, total_points_exam3_physics)
